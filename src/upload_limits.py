...
MARKETMATCH_CALL_AUDIO_MAX_BYTES = read_byte_limit_env(
    "MARKETMATCH_CALL_AUDIO_MAX_BYTES", 200 * 1024 * 1024
)
MARKETMATCH_VIDEO_MAX_BYTES = read_byte_limit_env(
    "MARKETMATCH_VIDEO_MAX_BYTES", 100 * 1024 * 1024
)
